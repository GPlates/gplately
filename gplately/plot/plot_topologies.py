...
from ._axes_tools import (
    meridian_from_ax as _meridian_from_ax,
)
from ._clean_polygons import (
    clean_polygons as _clean_polygons,
)
from .subduction_teeth import plot_subduction_teeth
...
from ..ptt.resolve_topologies import resolve_topologies_into_features
from ..ptt.velocity_tools import (
    get_plate_velocities,
    make_GPML_velocity_feature,
    get_x_y_u_v,
)
...
class PlotTopologies:
    ...
    * assorted reconstructable feature data, for example:
    ...
    def update_time(self, time):
        ...
        resolved_topologies = resolve_topologies_into_features(
    ...
    def plot_plate_motion_vectors(
        ...
        **kwargs :
        ...
        delta_time = 5.0
        all_velocities = get_plate_velocities(
        ...
        X, Y, U, V = get_x_y_u_v(lons, lats, all_velocities)
