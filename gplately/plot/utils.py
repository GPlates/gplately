...
def shapelify_features(features, central_meridian=0.0, tessellate_degrees=None):
    """Generate Shapely geometries from `pygplates.Feature`, `pygplates.ReconstructedFeatureGeometry` or `pygplates.GeometryOnSphere`.
    ...
    Parameters
    ----------
    features : iterable of `pygplates.Feature`, `pygplates.ReconstructedFeatureGeometry` or `pygplates.GeometryOnSphere`
    ...
    all_geometries : list of `shapely.geometry.BaseGeometry`
     ...
     .. seealso::
        ...
        :py:meth:`gplately.geometry.pygplates_to_shapely` : convert PyGPlates geometry objects to Shapely geometries.
    """
    if isinstance(
        features,
        (
